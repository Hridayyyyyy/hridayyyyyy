...
| 🖼️ CIFAR-10 CNN Image Classification | CNN-based image classification model trained on the CIFAR-10 dataset to classify images into 10 categories. | TensorFlow • Keras • CNN • Python
